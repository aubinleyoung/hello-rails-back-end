...
```sh
  git clone https://github.com/aubinleyoung/hello-rails-back-end.git
...
Feel free to check the [issues page](https://github.com/aubinleyoung/hello-rails-back-end/issues).
